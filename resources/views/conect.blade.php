                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="contact_details">
                            ...
                            <p> your opinion is important to us ..please express it or posit a problem fields must be filled aside..thank you.</p>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4>Address</h4>
                                    <h5>ajman_sheikh khalifa و golden tower next to dana mall</h5>
                                </div>
                            </div>
                            <div class="media">
                                <div class="media-left">
                    ...
                    <div class="col-md-6">
                        <div class="row contact_form_area">
                            ...
                            <form action="/adds" method="post">
                                ...
                                <div class="form-group col-md-12">
                                  <textarea class="form-control" id="text_problems" name="text_problems"  placeholder="Write Message"></textarea>
                                </div>
                                <div class="form-group col-md-12">
