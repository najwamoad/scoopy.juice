                 ...
                 @if(count($w))
                    ...
                    <div class="col-md-4">
                        <div class="recent_blog_item">
                            <div class="blog_img">
                                <img src="{{$s->imags}}" width=300 height=300 alt="">
                            </div>
                            <div class="recent_blog_text">
                                <div class="recent_blog_text_inner">
                                    <h6><a href="#">Articles</a></h6>
                                    <a href="blog-details.html"><h5>{{$s->title}}</h5></a>
                                    <p>{{$s->details}}.</p>
                                  <h6>Posted   <a href="#">.. </a>at {{$s->date_news}}</h6>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    ...
                    <div class="pull-right">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a class="active" href="/enNews">News</a></li>
